...
import geo_tools
# Constants
GEOJSON_FILENAME: str = "france.geojson"
GEOJSON_URL: str =\
...
def save_plotly(
    ...
    def wrapper(
        ...
        *args: Positional arguments to pass to the original function.
        ...
        with open(f"{func.__name__}.png", "wb") as file:
...
def geopandas_fit_to_bounds(
    ...
    figure.subplots_adjust(**{"left": 0.05, "right": 1,
                              "top": .935, "bottom": .05,
                              "wspace": 0, "hspace": 0})
    figure.savefig("geopandas_default.png")
    ...
    figure.savefig("geopandas_fit_to_bounds.png")
